    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" :value="__('current_password')" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" :value="__('new_password')" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" :value="__('confirm_password')"  />
