    ...
    <jet-action-section>
        ...
        <template #content>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500 dark:text-gray-200">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">{{ __('this_device')}}</span>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                     {{ __('logout_other_sessions_confirm')}}
                    <div class="mt-4">
                        <jet-input type="password" class="mt-1 block w-3/4" :placeholder="__('login_password')"
                                    ref="password"
