<template lang="">
    <div  v-if="$can('module.index')" class="grid grid-cols-1 ">
        <div class="col-span-1">

            <div class="m-auto w-full lg:col-span-1">
                <label  class="sr-only"></label>
                <div class="relative block w-full p-1">
                    <search-input v-model="params.searchm"  :placeholder="__('search')" class="mb-1 w-full" />
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                params : {
                    module : this.tbfilters.module === null ? '' : this.tbfilters.module,
                    search : this.tbfilters.searchm,
                    field :  this.tbfilters.fieldm,
                    direction :  this.tbfilters.directionm,
                }
            }
        },
        watch: {
