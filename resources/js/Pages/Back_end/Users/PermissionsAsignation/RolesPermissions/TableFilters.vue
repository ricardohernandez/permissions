        ...
        <div class="col-span-1">
            ...
            <div class="m-auto w-full lg:col-span-1">
                ...
                <div class="relative block w-full p-1">
                    <search-input v-model="params.searchh"  :placeholder="__('search')" class="mb-1 w-full" />
                </div>
            </div>
        ...
        data(){
            return {
                params : {
                    ...
                    search : this.tbfilters.searchh,
                    field :  this.tbfilters.fieldh,
                    direction :  this.tbfilters.directionh,
                }
            }
        },
        watch: {
